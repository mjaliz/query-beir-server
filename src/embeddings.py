...
class EmbeddingService:
    ...
    def embed_corpus_batch(self, corpus_batch: List[Dict[str, Any]]) -> List[List[float]]:
    ...
    def embed_corpus(self, corpus_path: str, qrels_path: str) -> Generator[Dict[str, Any], None, None]:
